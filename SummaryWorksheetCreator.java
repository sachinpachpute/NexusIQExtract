...
public class NexusReportExporter {
    ...
    public static void main(String[] args) {
        try {
            ...
            /*for (Map.Entry<String, String > entry : applications.entrySet()){
                ...
                reportId = getReportIdForGivenApplication(id);
    ...
    private static String getReportIdForGivenApplication(String applicationInternalId) throws IOException{
        ...
        for (JsonNode stageNode : rootNode) {
            if (stageNode.path("stage").asText().equalsIgnoreCase("release")){
    ...
    private static void populateNextVersionWithNoPolicyViolation(ApplicationDependency applicationDependency) throws IOException {
        ...
        URL urlObj = new URL(NEXUS_IQ_URL + "/api/v2/components/remediation/application/" + applicationDependency.getApplicationInternalId());
